...
jQuery(document).ready(function($){
    ...
    $element = $('.searchForm'),
    $element2 = $('.searchForm .form-body'),
     $element3 = $('.searchForm .form-actions'),
     $element4 = $('.medecin'),
    $element5 = $('.ouSeparator'),
     $element6 = $('.specialite'),
      $element7 = $('.adresse'),
      $element8 = $('.dateHeure'),
      $element9 = $('.form-group.last'),
       $element10 = $('.searchForm .portlet-title'),
        $element11 = $('.searchForm .portlet-body'),
